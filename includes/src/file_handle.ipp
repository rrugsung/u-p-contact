...
void mpm::FileHandle::write_data(unsigned& step, mpm::MpmParticle* &particles, mpm::Mesh* &mesh) {
    ...
    std::string totalstressFile = ResultsDir + "/totalstress" + std::to_string(step) + ".vtk";
    std::string tsFile = ResultsDir + "/ts" + std::to_string(step) + ".vtk";
    std::string pcFile = ResultsDir + "/pc" + std::to_string(step) + ".vtk";
    std::string voidratioFile = ResultsDir + "/voidratio" + std::to_string(step) + ".vtk";
    std::string oedFile = ResultsDir + "/OED.vtk";
    ...
    std::ofstream oedOut(oedFile.c_str(), std::ios::app);
    std::ofstream totalstressOut(totalstressFile.c_str());
    std::ofstream tsOut(tsFile.c_str());
    std::ofstream pcOut(tsFile.c_str());
    std::ofstream voidratioOut(tsFile.c_str());
    ...
    particles->write_particle_totalstress_data_to_file(totalstressOut);
    particles->write_particle_ts_data_to_file(tsOut);
    //particles->write_particle_preconsolidation_pressure_data_to_file(pcOut);
    //particles->write_particle_void_ratio_data_to_file(voidratioOut);
