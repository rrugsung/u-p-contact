...
public:
  ...
  // WRITE PARTILE TOTAL STRESS DATA
  void write_particle_totalstress_data_to_file(std::ostream& outFile);

  // WRITE MEAN & DEVIATORIC STRESS DATA
  void write_particle_ts_data_to_file(std::ostream& outFile);
  ...
  void write_particle_preconsolidation_pressure_data_to_file(std::ofstream &outFile);
  void write_particle_void_ratio_data_to_file(std::ofstream &outFile);
