...
public:
  ...
  template<typename FP>
  void iterate_over_inner_elements(FP function) const;
...
protected:
  ...
  // Set of inner elements for GIMP
  std::set<mpm::Element*, mpm::comparator<mpm::Element*> > inner_element_set_;
  ...
  Eigen::Matrix<double, 1, dim> rigid_mesh_spacing_;
