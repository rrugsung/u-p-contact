...
void mpm::material::ILE::compute_stress(const Eigen::Matrix<double, 1, dof>& dstrain, Eigen::Matrix<double,1,6>& stress, double& pressure,double& pc, double& void_ratio) {
