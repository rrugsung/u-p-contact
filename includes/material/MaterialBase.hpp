...
public:
  ...
  //virtual double give_void_ratio() = 0;
  //virtual double give_pc() = 0;
  virtual void compute_stress(const Eigen::Matrix<double,1,dof>& dstrain, Eigen::Matrix<double,1,6>& stress, double& pressure, double& pc, double& void_ratio) = 0;
